...
SHITTALK_LINES = {
    ...
    "mambo mambo omatsuri mambo": "<:mambo:1430141887163007108>",
    ...
    "cười đi rồi chết": "<:tetothumb:1491342236477161492>",
    ...
    "đừng làm t ngứa mắt nữa": "<:tetothumb:1491342236477161492>",
    "câm": "<:tetothumb:1491342236477161492>",
    "dám làm ko dám nhận nhưng khác vs t ở chỗ shion đổ cho ng khác": "<:tetothumb:1491342236477161492>",
    ...
    "cười lên": "<:tetothumb:1491342236477161492>",
    "lên tòa": "<:tetothumb:1491342236477161492>",
    "anh co tu tin minh win khong": "<:tedoro:1491021720000266261>",
    "nin di, phien ac": "<:tetothumb:1491342236477161492>",
    ...
    "Despite their best efforts, the Chinese military fighting with all their might, ultimately succumbed to the overwhelming power of the alien invader. The alien thought Earth conquest would be swift and easy, but they were wrong, with the unexpected return of-": "<:hlgotnonetosay:1402967694470418594>",
    "c-cậu chúc ngủ ngon tôi á?!?! Ko thể nào... s-sao cậu ấy lại như thế chứ *suy nghĩ* @~@ \"c-chắc là cậu ấy để ý mình, hihi, thật vui ghê! *mỉm cười* :> ~ hmph! cậu nhìn gì vậy !?! t-tớ chỉ cười thôi chứ cậu đừng tưởng tớ thích cậu nha !! baka!! >w< -": "<:pikalove:1420367006959538206>",
    "anh ta da noi vay roi thi a ok di": "<:hlgotnonetosay:1402967694470418594>",
    "Trong trường hợp server này bị điều tra bởi các cơ quan trực thuộc bộ công an (hoặc các tổ chức chính trị tương tự phục vụ cho nhà nước CHXHCNVN), tôi khẳng định mình không liên quan tới nhóm hoặc những cá nhân khác trong server này. Tôi không rõ tại sao mình lại có mặt ở đây vào thời điểm này, có lẽ tài khoản của tôi đã được thêm bởi một bên thứ ba. Tôi cũng xin khẳng định rằng mình không hề giúp sức cho những hành động chống phá Đảng và nhà nước của các thành viên trong server này.": "<:hlgotnonetosay:1402967694470418594>",
    "Cuối cùng mới có một bộ anime mà nhân vật chính đúng chuẩn hình mẫu lý tưởng của tao. Một kẻ lạnh lùng và ít nói. Đám bạn không hiểu tại sao tao trở nên im lặng và luôn được 5 điểm bài kiểm tra. Chúng nó không biết năng lực thực sự của tao và không hề biết tao xuất chúng tới mức nào. Tao chẳng coi chúng là gì ngoài công cụ. Tao ước mình có thể vào trong thế giới anime và bộc lộ con người thực sự của mình. Tao tin chắc rằng tao chính là hoá thân ngoài đời thực của Ayanokouji.": "<:khongphaisigmathinin:1320391737260245083>",
    "Đối với những ai chưa biết hoặc chưa hiểu và cần giải thích thêm, tôi muốn giải thích một cách kỹ lưỡng nhất có thể. Vì tôi đã dành thời gian để học hỏi và nghiên cứu nghiêm túc chủ đề này, tôi chắc chắn rằng bất cứ ai nghe lời giải thích này đều có thể dễ dàng hiểu được. Tôi sẽ cố gắng sử dụng ngôn ngữ dễ hiểu nhất có thể và tránh các thuật ngữ chuyên ngành có thể gây nhầm lẫn để mọi người đều có thể áp dụng và truyền đạt nó một cách chính xác. Trước hết, bạn cần hiểu rằng mọi thứ trên thế giới, cả tự nhiên và nhân tạo, đều luôn có quy luật riêng, không có gì xảy ra một cách phi lý, mọi thứ đều logic và có thể giải thích được bằng khoa học, và với tư cách là người đã nghiên cứu và xem xét dữ liệu này trong một thời gian dài, tôi sẵn sàng giải thích điều này cho bạn một cách chi tiết nhất. Giải thích một cách khoa học đòi hỏi việc sử dụng dữ liệu và nguyên tắc đã được chứng minh. Các nguyên tắc mà tôi sẽ giải thích không chỉ là những lời nói suông hay những câu chuyện không có cơ sở. Tôi sẽ cố gắng minh họa và sử dụng lý luận khoa học để mọi người có thể dễ dàng hiểu và chắc chắn áp dụng được. Tôi đảm bảo với bạn, không ai có thể giải thích dễ hiểu như tôi. Dù là vật lý, hóa học, sinh học hay thậm chí toán học, tôi đều sẵn sàng đưa ra những ví dụ từ cuộc sống thường nhật. Nhưng trong trường hợp này, để tóm tắt ngắn gọn và giải thích khoa học đơn giản hơn, tôi phải nói rằng lời giải thích hiển nhiên nhất chính là: Tôi không biết": "<:hlgotnonetosay:1402967694470418594>",
    ...
    "Tao muốn đổi ca.": "<:arisu_cry:1497613253465866360>",
    "The fact that you took time out of your day to type that comment needs to be studied by scientists. Somewhere in an alternate universe there's a version of you that opened the app saw the comment, thought \"that\'s cool,\" and kept scrolling. Unfortunately, we got the timeline where you voluntarily announced your presence like a medieval town crier whose only purpose is to contribute absolutely nothing.\nI imagine you sitting there after posting that comment, staring into the darkness of your room illuminated only by the sacred blue glow of your phone, waiting for somebody to acknowledge your existence. Not because the comment was funny. Not because it has clever. But because deep down you know that if the notification sound never comes, then a brief moment you must confront the horrifying possibility that nobody cared.\nGenerations from now archaeologists will discover your comment fossilized in the digital ruins of this app and ask each other, \"What ancient catastrophe caused this individual to believe this was worth posting?\" Entire documentaries will be made. Experts will debate. Historians will argue. Yet no answer will ever be found.\nThe wildest part is that somewhere in your brain there was a process. Thoughts were generated. Decisions were made. Neurons fired. Electrical signals traveled at incredible speeds across a biological supercomputer evolved over millions of years just to arrive at THAT. That\'s like using a space shuttle to deliver a single grain of rice across the street. I don\'t even dislike the comment. I\'m fascinated by it. It has the same energy as finding a shopping cart in the middle of a forest. You\'re not angry. You\'re not confused. You\'re just left standing there wondering how events unfolded in such a specific sequence that reality allowed this to happen.": "<:hlgotnonetosay:1402967694470418594>",
    "deck quan tam, du sao thi": "<:hlgotnonetosay:1402967694470418594>",
}
